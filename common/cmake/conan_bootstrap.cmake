function(conan_bootstrap)
    ...
    if (NOT TARGET CONAN_DONE::${BS_SCOPE_NAME})
        ...
        if(ANDROID_ABI STREQUAL armeabi-v7a)
            set(CONAN_PROFILE "${BS_SRCROOT}/conan/profiles/android-arm.jinja")
        elseif(ANDROID_ABI STREQUAL arm64-v8a)
            set(CONAN_PROFILE "${BS_SRCROOT}/conan/profiles/android-arm64.jinja")
        elseif(ANDROID_ABI STREQUAL x86)
            set(CONAN_PROFILE "${BS_SRCROOT}/conan/profiles/android-x86.jinja")
        elseif(ANDROID_ABI STREQUAL x86_64)
            set(CONAN_PROFILE "${BS_SRCROOT}/conan/profiles/android-x86_64.jinja")
        elseif(CMAKE_SYSTEM_NAME STREQUAL Linux)
            set(CONAN_PROFILE "${BS_SRCROOT}/conan/profiles/linux-clang")
        elseif(WIN32)
            set(CONAN_PROFILE "${BS_SRCROOT}/conan/profiles/windows-clang-cl.jinja")
        elseif(APPLE)
            set(CONAN_PROFILE "${BS_SRCROOT}/conan/profiles/apple-${TARGET_OS}.jinja")
