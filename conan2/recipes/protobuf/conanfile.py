...
class ProtobufConan(ConanFile):
    ...
    def package(self):
        copy(self, "*.h", self.source_folder, dst=join(self.package_folder, "include"), keep_path = True)
        copy(self, "*.inc", self.source_folder, dst=join(self.package_folder, "include"), keep_path = False)
